...
ttfs: test_tagfs.c tagdb.c util.c tokenizer.c code_table.c stream.c tagdb_priv.c set_ops.c query.c types.c
	gcc -Wall -Wno-implicit-function-declaration -g -o ttfs `pkg-config --libs --cflags glib-2.0` test_tagfs.c tagdb.c util.c tokenizer.c code_table.c stream.c tagdb_priv.c set_ops.c query.c types.c
ttdb: test_tagdb.c tagdb.c code_table.c util.c tokenizer.c set_ops.c stream.c tagdb_priv.c query.c types.c log.c
	gcc -g -o ttdb `pkg-config --libs --cflags glib-2.0 fuse` test_tagdb.c tagdb.c code_table.c util.c tokenizer.c set_ops.c stream.c tagdb_priv.c query.c types.c log.c
