...
ttdb: test_tagdb.c tagdb.c code_table.c util.c tokenizer.c set_ops.c stream.c tagdb_priv.c query.c types.c
	gcc -g -o ttdb `pkg-config --libs --cflags glib-2.0 fuse` test_tagdb.c tagdb.c code_table.c util.c tokenizer.c set_ops.c stream.c tagdb_priv.c query.c types.c
